...
| Transit 🚌 | Operator GTFS-Realtime VehiclePositions (8 keyless regions, `src/data/transitFeeds.js`) | `src/layers/transit/` via `src/app/layers/transit.js` | `/api/transit` | 15s (poll + delayed playback) |
...
NGSI v2 via Porto Digital). Mode silhouettes
